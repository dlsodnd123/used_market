...
CREATE TABLE `product` (
  ...
  `pd_title` varchar(25) DEFAULT NULL,
  `pd_category` varchar(10) DEFAULT NULL,
  `pd_content` longtext,
  `pd_price` int DEFAULT NULL,
  `pd_deal` varchar(3) DEFAULT NULL,
  `pd_registerDate` date DEFAULT NULL,
  `pd_isSail` varchar(1) DEFAULT NULL,
  `pd_isDel` varchar(1) DEFAULT NULL,
