...
CREATE TABLE `member` (
  ...
  `mb_email` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `member` VALUES ('qweqwe123','qweqwe123','홍길동','남','28681','충북 청주시 서원구 남들로13번길 1','충북 청주시 서원구 수곡동 92-31','1층',11112222,'qweqwe123@naver.com','normal','2021-01-29 16:35:36','N',NULL,'mb');
