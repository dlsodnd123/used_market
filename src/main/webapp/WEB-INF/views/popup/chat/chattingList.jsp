...
<body>
	...
	<c:if test="${member == null }">
		<div class="container chattingList-error">
	    	<div class="chattingList-error-message"><i class="fas fa-exclamation-triangle"></i> 잘못된 접근 방식입니다.</div>
    	</div>
	</c:if>
</body>
<script type="text/javascript">	
	$('.chatList-content-box').click(function(){
		...
		var buyer = $(this).find('.chatList-party-id').text();
		var url = '<%=request.getContextPath()%>/popup/chatting?pd_num=' + chro_pd_num + '&buyer=' + buyer;
